...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-014-0016-algebraic-stories-symbolic-powers-vs-o-4b6a55fa",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-014-0016-82aadf643fa5",
        "url": "https://www.unsolvedmath.com/problems/AMR-014-0016"
      }
    ],
    "statement": {
      "language": "en",
      "text": "For the ideal $I$ of $s$ general points in $\\mathbb P^{n-1}$, what is the difference between the Hilbert series of the $m$-th symbolic power and the $m$-th ordinary power?",
      "version": 1
    },
    "title": "Algebraic Stories — Symbolic powers vs. ordinary powers.",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "65ea0998f3e495b6fc1be68c616732cc781acfd2af64f28ca545e19c4241be01"
}
```
